...
//
model.load = function(){
    var client = {clientId: 's6BhdRkqt3', clientSecret: '8sdg578sd5g78sd5g8', redirectUri: 'http://localhost:3000/secret'};
    var user = {username: 'joe', password: 'password', firstname: 'Joe', lastname: 'Bloggs', email: 'joe@bloggs.com'};            
    
    var OAuthClients = new OAuthClientsModel(client);
    var OAuthUser = new OAuthUsersModel(user);
